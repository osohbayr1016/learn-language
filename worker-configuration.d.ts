/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5420d1fbe6f224050c3e40749e462a42)
// Runtime types generated with workerd@1.20260804.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	APP_ENV: "development";
	USER_STATE: DurableObjectNamespace<import("./worker/index").UserStateDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "UserStateDO";
	}
